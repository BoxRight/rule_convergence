...
### **Step 1: Check Status**
```bash
python3 methods/batch_evaluation_manager.py status
```
...
```bash
# Find next batch
python3 methods/batch_evaluation_manager.py next evaluator_1

# Create template for that batch (e.g., Batch 1)
python3 methods/batch_evaluation_manager.py template 1 evaluator_1
```

### **Step 3: Evaluate the Batch**
1. Open `materials/evaluations/evaluator_1/batch_1_template.json`
2. For each thesis in the batch:
   - Read the source text (`materials/texts/tesis[ID].txt`)
...
python3 methods/batch_evaluation_manager.py template 1 evaluator_2
```
...
python3 methods/batch_evaluation_manager.py merge evaluator_1

# Merge evaluator 2's batches
python3 methods/batch_evaluation_manager.py merge evaluator_2
```

This creates:
- `materials/evaluations/evaluator_1_complete.json`
- `materials/evaluations/evaluator_2_complete.json`
