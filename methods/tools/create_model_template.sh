...
# Model Template Generator — deprecated single-thesis models; prefer unified model
...
MODEL_FILE="$REPO_ROOT/methods/models/tesis${THESIS_NUM,,}_conclusion.wit"
...
echo "2. Prefer extending: $REPO_ROOT/methods/analysis/unified_legal_conclusions.wit"
echo "3. Test with: $REPO_ROOT/methods/tools/validate_unified.sh"
